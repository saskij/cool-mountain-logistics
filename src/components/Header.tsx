        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="flex items-center justify-between py-2 text-xs">
            ...
            <div className="flex items-center gap-6">
              ...
              {/* DOT / MC (Hidden on smallest mobile screens to save space) */}
              <div className="hidden sm:flex items-center gap-2.5 text-white/50 font-medium tracking-wide">
                <span>USDOT <span className="text-white/80">04371123</span></span>
                <span className="w-1 h-1 rounded-full bg-white/20" />
                <span>MC <span className="text-white/80">1712055</span></span>
              </div>
            </div>
